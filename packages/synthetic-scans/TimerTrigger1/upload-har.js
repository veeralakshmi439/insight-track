...
async function uploadHARToBlobStorage(context, filePath) {
  try {
    const connectionString = process.env.STORAGE_ACCOUNT_CONNECTION_STRING;
    const containerName = "synthetic-scan-har-files"; // Use the name of your existing container
